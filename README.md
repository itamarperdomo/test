# Curso de Python fugaz

* [MODULO 1 curso-minimo-python-1-fundamentos.md](curso-minimo-python-1-fundamentos.md)
    - Caracteristicas de python
    - PORQUE PYTHON (y porque no deberia usarlo tambien)
    - Porque la comparacion con C o Java
    - Convertir o pasar de python a otro lenguaje
    - Ejemplo y porque tuvo exito
...
* Gemini | Google
  * modulo rapido plus pago
* Aprenda a Pensar Como un Programador | Green Tea Press Wellesley, Massachusetts
  * Allen Downey, Jeffrey Elkner, Chris Meyers
  * Miguel Ángel Vilella, Ángel Arnal, Iván Juanes, Litza Amurrio, Efrain Andia, César Ballardini
* Python para todos | distribucion libre CC-BY
  * Raul Gonzales Duque

## Advertencia

Este curso se recomienda usar la iso en http://10.10.34.30:18080/webdav/
